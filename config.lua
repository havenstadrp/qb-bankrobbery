...
Config.LockerRewards = {
    ["tier1"] = {
        [1] = {item = "goldchain", minAmount = 1, maxAmount = 5},
    },
    ["tier2"] = {
        [1] = {item = "rolex", minAmount = 1, maxAmount = 5},
    },
    ["tier3"] = {
...
Config.LockerRewardsPaleto = {
    ["tier1"] = {
        [1] = {item = "goldchain", minAmount = 5, maxAmount = 10},
        [2] = {item = "10kgoldchain", minAmount = 1, maxAmount = 5},
    },
    ["tier2"] = {
        [1] = {item = "rolex", minAmount = 2, maxAmount = 5},
    },
    ["tier3"] = {
...
Config.LockerRewardsPacific = {
    ["tier1"] = {
        ...
        [2] = {item = "diamondring", minAmount = 2, maxAmount = 5},
    },
    ["tier2"] = {
        [1] = {item = "goldbar", minAmount = 4, maxAmount = 8},
        [2] = {item = "diamondring", minAmount = 2, maxAmount = 5},
